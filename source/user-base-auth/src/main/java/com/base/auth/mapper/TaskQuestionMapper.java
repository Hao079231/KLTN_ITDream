...
public interface TaskQuestionMapper {
  ...
  List<TaskQuestionDto> fromEntityToTaskQuestionDtoList(List<TaskQuestion> questions);
  ...
  List<TaskQuestionEducatorDto> fromEntityToTaskQuestionEducatorDtoList(List<TaskQuestion> questions);
