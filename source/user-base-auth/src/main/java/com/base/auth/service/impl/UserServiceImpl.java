...
public class UserServiceImpl implements UserDetailsService {
    ...
    public OAuth2AccessToken getAccessTokenForUser(ClientDetails client, TokenRequest tokenRequest, String password, String email, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        Map<String, String> requestParameters = new HashMap<>();
    ...
    public OAuth2AccessToken getAccessTokenForEducator(ClientDetails client, TokenRequest tokenRequest, String password, String email, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        Map<String, String> requestParameters = new HashMap<>();
    ...
    public OAuth2AccessToken getAccessTokenForGoogleStudent(ClientDetails client, TokenRequest tokenRequest, String accessToken, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        Map<String, String> requestParameters = new HashMap<>();
        requestParameters.put("grantType", SecurityConstant.GRANT_TYPE_STUDENT);
